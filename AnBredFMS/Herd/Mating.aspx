<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ControlPanel.Master" AutoEventWireup="true" CodeBehind="Mating.aspx.cs" Inherits="AnBredFMS.Herd.Mating" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        <section class="content-header" style="margin-right: 7px; margin-left: 7px;">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">Phối giống</a></li>
            </ol>
        </section>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <blockquote class="info-title">
                                        <p><code class="titleReport"><i class="fa fa-angle-double-right"></i>&nbsp;BÁO PHỐI </code></p>
                                ...
                                <div class="col-md-4" style="padding-top: 30px; padding-right: 15px; text-align: right">
                                    <a class="anbred-link-toolbar" href="#"><i class="fa fa-history"></i>Nhật ký Phối</a>
                                </div>
                            </div>

                            <div class="anbred-scroll-container">

                                <div id="hot-mating"></div>
    ...
    <!-- handsontable -->
    <script>                
                var container = document.getElementById('hot-mating');

                hot_mating_tbl = new Handsontable(container, {
                    data: [],
                    startCols: 16,
                    dataSchema: {
                        earTag: null, type: null, parity: null, matingNo: null, heatPoint: null, matingDay: null, boar: null, NPD: null, technical: null, note: null
                    },
                    colWidths: [100, 70, 70, 70, 90, 100, 100, 60, 120, 120],
                    colHeaders: ['Số tai', 'Nhóm<br/>nái',  'Lứa<br/>đẻ', 'Lần<br/>phối', 'Độ phê', 'Ngày phối', 'Nọc', 'NPD', 'Người phối', 'Ghi chú'],
                    columns: [
                        { data: 'earTag' },
                        { data: 'type' },
                        { data: 'parity' },
