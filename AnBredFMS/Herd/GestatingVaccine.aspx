<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ControlPanel.Master" AutoEventWireup="true" CodeBehind="GestatingVaccine.aspx.cs" Inherits="AnBredFMS.Herd.GestatingVaccine" %>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-4" style="padding-top: 30px; padding-right: 15px; text-align: right">
                                    <a class="anbred-link-toolbar" href="GestVacWeekly.aspx"><i class="fa fa-flag-o" style="padding-right:10px"></i>Theo tuần mang thai</a>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered table-hover anbred-table-default">
                                        <thead>
                                            <tr class="anbred-tblReport-row-header">
                                                ...
                                                <th rowspan="2">Số tai nái</th>                                                
                                                <th class="col-md-1" rowspan="2">Nhóm</th>
                                                <th class="col-md-1" rowspan="2">Lứa đẻ</th>
                                                <th class="col-md-1" rowspan="2">Lần phối</th>
                                                <th class="col-md-1" rowspan="2">Ngày cai sữa</th>
                                                <th class="col-md-1" rowspan="2">Ngày phối</th>
                                                <th class="col-md-1" colspan="6">Loại vaccine</th>
                                                <th class="col-md-1" rowspan="2">Ngày đẻ dự kiến</th>
                                            </tr>
                                            <tr class="anbred-tblReport-row-header">
                                                <th class="col-md-1">CSF</th>
                                                <th class="col-md-1">FMD</th>
                                                <th class="col-md-1">PRRS</th>
                                                <th class="col-md-1">E.Coli</th>
