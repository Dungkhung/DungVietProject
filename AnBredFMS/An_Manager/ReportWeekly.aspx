<%@ Page Title="" Language="C#" MasterPageFile="~/An_Manager/ControlPanel.Master" AutoEventWireup="true" CodeBehind="ReportWeekly.aspx.cs" Inherits="AnBredFMS.An_Manager.ReportWeekly" %>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <blockquote class="info-title">
                                        <p><code class="titleReport">&gt;&gt; BÁO CÁO TUẦN </code></p>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="anbred-tblrow-align-right has-col-rate">
                                            ...
                                            <td class="cell-bg-disable">&nbsp;</td>
                                            <td class="cell-border-left">&nbsp;</td>
                                            <td class="cell-border-left" rowspan="12">
